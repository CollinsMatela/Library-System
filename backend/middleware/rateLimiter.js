...
export const changePassLimiter = rateLimit({
    windowMs: 15 * 60 * 1000,
    max: 10,
    standardHeaders: true,
    legacyHeaders: false,
...
export const AISummarizationLimiter = rateLimit({
    windowMs: 15 * 60 * 1000,
    max: 5,
    standardHeaders: true,
    legacyHeaders: false,
    message: {
        success: false,
        message: "Too many AI summarization attempts. Please try again later."
    }
})
...
export const AIVideoLimiter = rateLimit({
    ...
    message: {
        success: false,
        message: "Too many AI video processing attempts. Please try again later."
    }
})
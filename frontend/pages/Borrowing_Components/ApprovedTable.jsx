                ...
                <div className="w-full justify-start items-center flex gap-2">
                    ...
                    <div className="grid grid-cols-3 w-full">
                        ...
                        <div className="justify-end items-center flex gap-2 w-full">
                            <input type="date" className="p-2 bg-stone-100 rounded-lg text-xs text-stone-500" value={returnDate[borrow._id] || ''} onChange={(e) => setReturnDate(prev => ({...prev, [borrow._id]: e.target.value}))}/>
                            <input type="number" min={1} className="p-2 w-20 bg-stone-100 rounded-lg text-xs text-stone-500" placeholder="Qty" value={quantity[borrow._id] || ''} onChange={(e) => setQuantity(prev => ({...prev, [borrow._id]: e.target.value}))}/>

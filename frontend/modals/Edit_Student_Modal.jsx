...
const Edit_Student_Modal = ({selectedUser, reFetch, closeEditStudentModal}) => {
    ...
    return(
        ...
        <section className="fixed z-50 inset-0 justify-center items-center flex">
           ...
           <div className="relative bg-white flex flex-col w-6xl rounded-2xl p-2 space-y-2 px-4">
               ...
               <div className="w-full">
                   ...
                   <input type="text" className={`border-1 border-gray-300 h-12 w-full outline-none rounded-xl px-4 text-gray-500`} onChange={(e) => setLastname(e.target.value)} value={lastname} />
               </div>
               <div className="w-full">
                   <h1 className="text-xs text-gray-500">Firstname</h1>
                   <input type="text" className={`border-1 border-gray-300 h-12 w-full outline-none rounded-xl px-4 text-gray-500`} onChange={(e) => setFirstname(e.target.value)} value={firstname} />
               </div>
               <div className="w-full">
                   <h1 className="text-xs text-gray-500">Middlename</h1>
                   <input type="text" className={`border-1 border-gray-300 h-12 w-full outline-none rounded-xl px-4 text-gray-500`} onChange={(e) => setMiddlename(e.target.value)} value={middlename} />
               </div>
               <div className="w-full flex flex-col">
                   <h1 className="text-xs text-gray-500">Date of birth</h1>
                        <div className="w-full flex gap-2">
                        <select name="year" className={`border-1 border-gray-300 h-12 w-20 outline-none rounded-xl px-4 text-gray-500`} onChange={(e) => setYear(e.target.value)} value={year}>
                            {Array.from({ length: 90 }, (_, i) => {
                                    const year = new Date().getFullYear() - i;
                                    return <option key={year} value={year}>{year}</option>;
                            })}
                        </select>
                        <select name="month" className={`border-1 border-gray-300 h-12 w-30 outline-none rounded-xl px-4 text-gray-500`} onChange={(e) => setMonth(e.target.value)} value={month}>
                        ...
                        <select name="day" className={`border-1 border-gray-300 h-12 w-20 outline-none rounded-xl px-4 text-gray-500`} onChange={(e) => setDay(e.target.value)} value={day}>
            ...
            <div className="w-full">
               ...
               <div className="w-full">
                ...
                <select name="sex" className={`border-1 border-gray-300 h-12 w-full outline-none rounded-xl px-4 text-gray-500`} onChange={(e) => setSex(e.target.value)} value={sex}>
            ...
            <h1 className="text-lg font-semibold text-gray-700 mb-4">Parent/Guardian Information</h1>
               ...
               <div className="w-full">
                   ...
                   <input type="text" className={`border-1 border-gray-300 h-12 w-full outline-none rounded-xl px-4 text-gray-500`} onChange={(e) => setParentLastname(e.target.value)} value={parentName} />
               </div>

                <div className="flex-1">
                        <h1 className="text-xs text-gray-500">Contact</h1>
                        <input type="text" className={`border-1 border-gray-300 h-12 w-full outline-none rounded-xl px-4 text-gray-500`} onChange={(e) => setParentContact(e.target.value)} value={parentContact} />
                </div>

                <div className="w-full flex gap-2">
                    <div className="flex-1">
                         <h1 className="text-xs text-gray-500">Relationship</h1>
                         <select name="relationship" className={`border-1 border-gray-300 h-12 w-full outline-none rounded-xl px-4 text-gray-500`} onChange={(e) => setParentRelationship(e.target.value)} value={parentRelationship}>
